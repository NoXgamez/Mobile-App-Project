...
public class LeaderboardsMenu : Panel
{
    ...
    public async void AddScoreAsync(int score)
    {
        ...
        try
        {
            var playerEntry = await LeaderboardsService.Instance.AddPlayerScoreAsync("Mobile-Game-Project1", score);
    ...
    private async void LoadPlayers(int page)
    {
        ...
        try
        {
            ...
            var scores = await LeaderboardsService.Instance.GetScoresAsync("Mobile-Game-Project1", options);
            ClearPlayersList();
