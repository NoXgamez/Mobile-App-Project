...
public class AuthenticationMenu : Panel
{
    ...
    {
        LeaderBoardManager.Singleton.SignInAnonymouslyAsync();
    }
    ...
    private void SignIn()
    {
        ...
        {
            LeaderBoardManager.Singleton.SignInWithUsernameAndPasswordAsync(user, pass);
        }
    }
    ...
    private void SignUp()
    {
        ...
        if (string.IsNullOrEmpty(user) == false && string.IsNullOrEmpty(pass) == false)
        {
            ...
            {
                LeaderBoardManager.Singleton.SignUpWithUsernameAndPasswordAsync(user, pass);
            }
            else
            {
